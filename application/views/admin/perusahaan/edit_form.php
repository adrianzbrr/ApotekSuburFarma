						...
						<input type="hidden" name="id" value="<?php echo $produk->idProduk?>" />
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('namaProduk') ? 'is-invalid':'' ?>"
								 type="text" name="namaProduk" placeholder="Nama" value="<?php echo $produk->namaProduk ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('hargaProduk') ? 'is-invalid':'' ?>"
								 type="number" name="hargaProduk" min="0" placeholder="Harga" value="<?php echo $produk->hargaProduk ?>"/>
								<div class="invalid-feedback">
