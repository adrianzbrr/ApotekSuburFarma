                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php base_url('admin/produk/edit') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?php echo form_error('idJenis') ? 'is-invalid' : '' ?>" type="number" name="idJenis" min="0" placeholder="Jenis">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?php echo form_error('idBentuk') ? 'is-invalid' : '' ?>" type="number" name="idBentuk" min="0" placeholder="Bentuk">
                                    <option value='0'>--PILIH--</option>
                                    <?php
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?php echo form_error('idRak') ? 'is-invalid' : '' ?>" type="number" name="idRak" min="0" placeholder="Rak">
                                    <option value='0'>--PILIH--</option>
                                    <?php
									foreach ($rak as $data) {
